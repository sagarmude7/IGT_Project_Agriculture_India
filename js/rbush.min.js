!(function (t) {
  ...
  return (function t(i, n, e) {
    ...
    for (
      var a = "function" == typeof require && require, h = 0;
      h < e.length;
      h++
    )
      r(e[h]);
      ...
      1: [
        function (t, i, n) {
          ...
          function e(t, i) {
            return this instanceof e
              ? ((this._maxEntries = Math.max(4, t || 9)),
                ...
                i && this._initFormat(i),
                void this.clear())
              : new e(t, i);
          }
          function r(t, i, n) {
            if (!n) return i.indexOf(t);
            for (var e = 0; e < i.length; e++) if (n(t, i[e])) return e;
            return -1;
          }
          function a(t, i) {
          ...
          e.prototype = {
              ...
              for (
                ...
                if (
                  (o ||
                    ...
                    (n = f.pop()),
                    (h = !0)),
                  o.leaf && ((a = r(t, o.children, i)), a !== -1))
                )
                  return (
                    o.children.splice(a, 1), l.push(o), this._condense(l), this
                  );
                h || o.leaf || !d(o, s)
                  ? e
                    ? (n++, (o = e.children[n]), (h = !1))
                    : (o = null)
                  : (l.push(o),
                    f.push(n),
                    (n = 0),
            ...
            _build: function (t, i, n, e) {
              var r,
                h = n - i + 1,
                o = this._maxEntries;
              if (h <= o)
                return (r = p(t.slice(i, n + 1))), a(r, this.toBBox), r;
              e ||
                ((e = Math.ceil(Math.log(h) / Math.log(o))),
                (o = Math.ceil(h / Math.pow(o, e - 1)))),
                (r = p([])),
                (r.leaf = !1),
                (r.height = e);
              var s,
                ...
                u,
                c = Math.ceil(h / o),
                m = c * Math.ceil(Math.sqrt(o));
              for (M(t, i, n, m, this.compareMinX), s = i; s <= n; s += m)
                for (
                  f = Math.min(s + m - 1, n),
                    M(t, s, f, c, this.compareMinY),
                    l = s;
                  l <= f;
                  l += c
                )
                  (u = Math.min(l + c - 1, f)),
                    r.children.push(this._build(t, l, u, e - 1));
            ...
            _insert: function (t, i, n) {
              var e = this.toBBox,
                r = n ? t : e(t),
                a = [],
                h = this._chooseSubtree(r, this.data, i, a);
              for (
                h.children.push(t), o(h, r);
                i >= 0 && a[i].children.length > this._maxEntries;
            ...
            _split: function (t, i) {
              ...
              var h = this._chooseSplitIndex(n, r, e),
            ...
            _chooseSplitAxis: function (t, i, n) {
              var e = t.leaf ? this.compareMinX : s,
                ...
                h = this._allDistMargin(t, i, n, r);
              a < h && t.children.sort(e);
            },
            _allDistMargin: function (t, i, n, e) {
              t.children.sort(e);
              var r,
                a,
                s = this.toBBox,
            ...
            _adjustParentBBoxes: function (t, i, n) {
              for (var e = n; e >= 0; e--) o(i[e], t);
            },
            _condense: function (t) {
              for (var i, n = t.length - 1; n >= 0; n--)
                0 === t[n].children.length
                  ? n > 0
                    ? ((i = t[n - 1].children), i.splice(i.indexOf(t[n]), 1))
                    : this.clear()
                  : a(t[n], this.toBBox);
            },
            ...
            for (; a > n; ) {
              if (a - n > 600) {
                var o = a - n + 1,
                  ...
                  m = Math.min(a, Math.floor(i + ((o - s) * f) / o + u));
                e(t, i, c, m, h);
              }
              var d = t[i],
                x = n,
              ...
              for (r(t, n, i), h(t[a], d) > 0 && r(t, n, a); x < p; ) {
                for (r(t, x, p), x++, p--; h(t[x], d) < 0; ) x++;
                for (; h(t[p], d) > 0; ) p--;
              }
              0 === h(t[n], d) ? r(t, n, p) : (p++, r(t, p, a)),
                p <= i && (n = p + 1),
                i <= p && (a = p - 1);
            }
          }
