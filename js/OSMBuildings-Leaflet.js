(function (ca) {
  ...
  function va(b) {
    ...
    g -= e;
    f = c / g;
    if (0.85 > f || 1.15 < f) return !1;
    d = { x: d + c / 2, y: e + g / 2 };
    c = (c + g) / 4;
    e = c * c;
    for (c = 0; c < a - 1; c += 2)
      if (((g = S({ x: b[c], y: b[c + 1] }, d)), 0.8 > g / e || 1.2 < g / e))
        return !1;
    return !0;
  }
  function ja(b, a) {
    ...
    f =
      0 >= a
        ...
        : 1 <= a
        ? -90
        : ((2 * xa(ya(E * (1 - 2 * a))) - J) / E) * 180;
    c[d] = f;
    c[za] = 360 * (1 === b ? 1 : ((b % 1) + 1) % 1) - 180;
    return c;
  }
  function da(b, a) {
    var c = U(1, K(0, 0.5 - Aa(ka(Ba + (J * b) / 180)) / E / 2));
    return { x: ((a / 360 + 0.5) * T) << 0, y: (c * T) << 0 };
  }
  function V(b) {
    for (var a = B + p, c = v + n, d = 0, f = b.length - 3; d < f; d += 2)
      if (b[d] > p && b[d] < a && b[d + 1] > n && b[d + 1] < c) return !0;
    return !1;
  }
  function Ca() {
    $ ||
      ($ = setInterval(function () {
        for (var b = F.items, a = !1, c = 0, d = b.length; c < d; c++)
          1 > b[c].scale &&
            ((b[c].scale += 0.1), 1 < b[c].scale && (b[c].scale = 1), (a = !0));
        A.render();
  ...
  var u = Math,
    ...
    t = !!~navigator.userAgent.indexOf("Trident"),
    Ga =
      !ca.requestAnimationFrame || u || t
        ? function (b) {
            b();
          }
    ...
    I = (function (b) {
      ...
      d.parse = function (a) {
        ...
        if ((m = a.match(/^#(\w{2})(\w{2})(\w{2})$/)))
          ...
          (b = parseInt(m[1], 10)),
            (d = parseInt(m[2], 10)),
            (h = parseInt(m[3], 10)),
            (k = m[4] ? parseFloat(m[5]) : 1);
        else return;
        return this.fromRGBA(b, d, h, k);
      };
      d.fromRGBA = function (a, b, c, h) {
        "object" === typeof a
          ? ((b = a.g / 255), (c = a.b / 255), (h = a.a), (a = a.r / 255))
          : ((a /= 255), (b /= 255), (c /= 255));
      ...
      d.prototype = {
        toRGBA: function () {
          var b = Math.min(360, Math.max(0, this.H)),
            c = Math.min(1, Math.max(0, this.S)),
            d = Math.min(1, Math.max(0, this.L)),
            h = Math.min(1, Math.max(0, this.A)),
            k;
          if (0 === c) b = k = c = d;
          else {
            var m = 0.5 > d ? d * (1 + c) : d + c - d * c,
              d = 2 * d - m,
              b = b / 360,
              c = a(d, m, b + 1 / 3);
            k = a(d, m, b);
    ...
    Ha = (function () {
      ...
      return function (b, l, y) {
        ...
        var s = h * (357.5291 + 0.98560028 * b),
          D;
        D = h * (1.9148 * c(s) + 0.02 * c(2 * s) + 3e-4 * c(3 * s));
        D = s + D + 102.9372 * h + a;
        s = e(c(0) * d(k) + d(0) * c(k) * c(D));
        D = g(c(D) * d(k) - f(0) * c(k), d(D));
        b = h * (280.16 + 360.9856235 * b) - y - D;
    ...
    Ja = (function () {
      ...
      function a(a, b) {
        var c,
          ...
          n;
        p = 0;
        for (n = a.length - 3; p < n; p += 2)
          (c = a[p]),
            (d = a[p + 1]),
            (f = a[p + 2]),
            (s = a[p + 3]),
            (D += c * s - f * d);
        if ((0 < D / 2 ? e : g) === b) return a;
        c = [];
      ...
      function c(b) {
        ...
        switch (b.type) {
          case "GeometryCollection":
            l = [];
            d = 0;
            for (f = b.geometries.length; d < f; d++)
              (y = c(b.geometries[d])) && l.push.apply(l, y);
            return l;
          case "MultiPolygon":
            l = [];
            d = 0;
            for (f = b.coordinates.length; d < f; d++)
              (y = c({ type: "Polygon", coordinates: b.coordinates[d] })) &&
                l.push.apply(l, y);
            return l;
          case "Polygon":
            b = b.coordinates;
      ...
      return {
        read: function (a) {
          ...
          for (f = a.length; d < f; d++)
            if (((n = a[d]), "Feature" === n.type && !1 !== ta(n))) {
              e = n.properties;
              g = {};
              e = e || {};
              ...
              if ((q = e.material ? b(e.material) : e.wallColor || e.color))
                g.wallColor = q;
              if ((q = e.roofMaterial ? b(e.roofMaterial) : e.roofColor))
                g.roofColor = q;
              switch (e.shape) {
                case "cylinder":
                case "cone":
              ...
              g.roofShape && e.roofHeight
                ? ((g.roofHeight = e.roofHeight),
                  (g.height = K(0, g.height - g.roofHeight)))
                : (g.roofHeight = 0);
              t = g;
              q = c(n.geometry);
              e = 0;
              for (g = q.length; e < g; e++) {
                ...
                var w = {},
                  u = void 0;
                for (u in r) r.hasOwnProperty(u) && (w[u] = r[u]);
                r = w;
                ...
                if (r.isRotational) {
                  for (
                    ...
                    (x = U(x, u[v + 1])), (z = K(z, u[v + 1]));
                  w.radius = (z - x) / 2;
                }
                q[e].inner && (r.holes = q[e].inner);
                if (n.id || n.properties.id) r.id = n.id || n.properties.id;
                n.properties.relationId &&
                  (r.relationId = n.properties.relationId);
                p.push(r);
              }
            }
          return p;
        ...
        if (a[b]) g && g(a[b]);
          ...
          h.onreadystatechange = function () {
            if (
              ...
              d += k.length;
              for (g(k); d > f; )
                (k = c.shift()), (d -= k.size), delete a[k.url];
            }
          };
          h.open("GET", b);
          h.send(null);
    ...
    F = {
      loadedItems: {},
      items: [],
      getPixelFootprint: function (b) {
        for (
          var a = new ra(b.length), c, d = 0, f = b.length - 1;
          d < f;
          d += 2
        )
          (c = da(b[d], b[d + 1])), (a[d] = c.x), (a[d + 1] = c.y);
        b = a;
        a = b.length / 2;
        c = new sa(a);
        var d = 0,
        ...
        for (c[d] = c[f] = 1; f; ) {
          ...
          2 < g && ((c[k] = 1), m.push(d), l.push(k), m.push(k), l.push(f));
          d = m.pop();
          f = l.pop();
        }
        for (e = 0; e < a; e++) c[e] && n.push(b[2 * e], b[2 * e + 1]);
        a = n;
        if (!(8 > a.length)) return a;
      },
      resetItems: function () {
        this.items = [];
        this.loadedItems = {};
      ...
      addRenderItems: function (b, a) {
        for (var c, d, f, e = Ja.read(b), g = 0, h = e.length; g < h; g++)
          (c = e[g]),
            (f =
              c.id ||
      ...
      scale: function (b) {
        ...
        if (
          !(a.minHeight > ga) &&
          ((a.footprint = this.getPixelFootprint(b.footprint)), a.footprint)
        ) {
          for (
            var d = a.footprint,
              f = Infinity,
          ...
          ("cone" !== a.roofShape && "dome" !== a.roofShape) ||
            a.shape ||
            !va(a.footprint) ||
            (a.shape = "cylinder");
          if (b.holes) {
            a.holes = [];
            for (var l, d = 0, f = b.holes.length; d < f; d++)
              (l = this.getPixelFootprint(b.holes[d])) && a.holes.push(l);
          }
          var n;
          b.wallColor &&
            (n = I.parse(b.wallColor)) &&
            ((n = n.alpha(C)),
            (a.altColor = "" + n.lightness(0.8)),
            (a.wallColor = "" + n));
          b.roofColor &&
            (n = I.parse(b.roofColor)) &&
            (a.roofColor = "" + n.alpha(C));
          ...
          if (!(a.height + a.roofHeight <= a.minHeight)) return a;
        }
      },
      set: function (b) {
        this.isStatic = !0;
      ...
      load: function (b, a) {
        this.src =
          b ||
          "http://{s}.data.osmbuildings.org/0.2/{k}/tile/{z}/{x}/{y}.json".replace(
            "{k}",
            a || "anonymous"
          );
        this.update();
        ...
        if (!(x < G))
          if (this.isStatic && this._staticData)
            ...
            var a = 16 < x ? 256 << (x - 16) : 256 >> (16 - x),
              ...
              g = this;
            for (e = d; e <= a; e++)
              for (d = c; d <= f; d++) this.loadTile(d, e, 16, b);
          }
      },
      loadTile: function (b, a, c, d) {
        b = this.src
          .replace("{s}", "abcd"[(b + a) % 4])
          .replace("{x}", b)
          .replace("{y}", a)
          .replace("{z}", c);
    ...
    Z = {
      draw: function (b, a, c, d, f, e, g, h) {
        var k,
          m = this._extrude(b, a, d, f, e, g),
          l = [];
        if (c)
          for (a = 0, k = c.length; a < k; a++)
            l[a] = this._extrude(b, c[a], d, f, e, g);
        b.fillStyle = h;
        b.beginPath();
        this._ring(b, m);
        if (c) for (a = 0, k = l.length; a < k; a++) this._ring(b, l[a]);
        b.closePath();
        b.stroke();
        b.fill();
      },
      _extrude: function (b, a, c, d, f, e) {
        ...
        for (
          ...
          (h.x = a[s] - p),
            ...
            (m = r.project(h, c)),
            (l = r.project(k, c)),
            d && ((h = r.project(h, g)), (k = r.project(k, g))),
            (k.x - h.x) * (m.y - h.y) > (m.x - h.x) * (k.y - h.y) &&
              ((b.fillStyle =
                (h.x < k.x && h.y < k.y) || (h.x > k.x && h.y > k.y) ? e : f),
              b.beginPath(),
              this._ring(b, [k.x, k.y, h.x, h.y, m.x, m.y, l.x, l.y]),
              b.closePath(),
              b.fill()),
            (y[s] = m.x),
            (y[s + 1] = m.y);
      ...
      _ring: function (b, a) {
        b.moveTo(a[0], a[1]);
        for (var c = 2, d = a.length - 1; c < d; c += 2)
          b.lineTo(a[c], a[c + 1]);
      },
      ...
      shadow: function (b, a, c, d, f) {
        for (
          ...
          (g.x = a[l] - p),
            ...
            (k = z.project(g, d)),
            (m = z.project(h, d)),
            f && ((g = z.project(g, f)), (h = z.project(h, f))),
            (h.x - g.x) * (k.y - g.y) > (k.x - g.x) * (h.y - g.y)
              ? (1 === e && b.lineTo(g.x, g.y),
                (e = 0),
                l || b.moveTo(g.x, g.y),
                b.lineTo(h.x, h.y))
              : (0 === e && b.lineTo(k.x, k.y),
                (e = 1),
                l || b.moveTo(k.x, k.y),
                b.lineTo(m.x, m.y));
        if (c) for (l = 0, q = c.length; l < q; l++) this._ringAbs(b, c[l]);
      },
      ...
      hitArea: function (b, a, c, d, f, e) {
        ...
        b.fillStyle = e;
        b.beginPath();
        for (var l = 0, t = a.length - 3; l < t; l += 2)
          (g.x = a[l] - p),
            (g.y = a[l + 1] - n),
            (h.x = a[l + 2] - p),
            (h.y = a[l + 3] - n),
            (e = r.project(g, d)),
            (m = r.project(h, d)),
            f && ((g = r.project(g, k)), (h = r.project(h, k))),
            (h.x - g.x) * (e.y - g.y) > (e.x - g.x) * (h.y - g.y)
              ? (1 === c && b.lineTo(g.x, g.y),
                (c = 0),
                l || b.moveTo(g.x, g.y),
                b.lineTo(h.x, h.y))
              : (0 === c && b.lineTo(e.x, e.y),
                (c = 1),
                l || b.moveTo(e.x, e.y),
                b.lineTo(m.x, m.y));
        b.closePath();
    ...
    w = {
      draw: function (b, a, c, d, f, e, g, h, k) {
        ...
        (m = this._tangents(a, c, f, d))
          ? ((e = P(m[0].y1 - a.y, m[0].x1 - a.x)),
            (m = P(m[1].y1 - a.y, m[1].x1 - a.x)))
          : ((e = 1.5 * E), (m = 1.5 * E));
        b.fillStyle = g;
        b.beginPath();
      ...
      shadow: function (b, a, c, d, f, e) {
        ...
        h
          ? ((e = P(h[0].y1 - a.y, h[0].x1 - a.x)),
            (g = P(h[1].y1 - a.y, h[1].x1 - a.x)),
            b.moveTo(h[1].x2, h[1].y2),
            b.arc(f.x, f.y, d, g, e),
            b.arc(a.x, a.y, c, e, g))
          : (b.moveTo(a.x + c, a.y), b.arc(a.x, a.y, c, 0, 2 * E));
      },
      shadowMask: function (b, a, c) {
        var d = a.x - p;
        a = a.y - n;
      ...
      hitArea: function (b, a, c, d, f, e, g) {
        ...
        b.beginPath();
        e
          ? ((g = P(e[0].y1 - a.y, e[0].x1 - a.x)),
            (h = P(e[1].y1 - a.y, e[1].x1 - a.x)),
            b.moveTo(e[1].x2, e[1].y2),
            b.arc(f.x, f.y, d, h, g),
            b.arc(a.x, a.y, c, g, h))
          : (b.moveTo(a.x + c, a.y), b.arc(a.x, a.y, c, 0, 2 * E));
        b.closePath();
    ...
    R = {
      draw: function (b, a, c, d, f, e, g) {
        ...
        d = { x: 0, y: 0 };
        for (var k = { x: 0, y: 0 }, m = 0, l = a.length - 3; m < l; m += 2)
          (d.x = a[m] - p),
            (d.y = a[m + 1] - n),
            (k.x = a[m + 2] - p),
            (k.y = a[m + 3] - n),
            f && ((d = r.project(d, h)), (k = r.project(k, h))),
            (k.x - d.x) * (c.y - d.y) > (c.x - d.x) * (k.y - d.y) &&
              ((b.fillStyle =
                (d.x < k.x && d.y < k.y) || (d.x > k.x && d.y > k.y) ? g : e),
              b.beginPath(),
              this._triangle(b, d, k, c),
              b.closePath(),
              b.fill());
      },
      ...
      shadow: function (b, a, c, d, f) {
        ...
        d = 0;
        for (var h = a.length - 3; d < h; d += 2)
          (e.x = a[d] - p),
            (e.y = a[d + 1] - n),
            (g.x = a[d + 2] - p),
            (g.y = a[d + 3] - n),
            f && ((e = z.project(e, f)), (g = z.project(g, f))),
            (g.x - e.x) * (c.y - e.y) > (c.x - e.x) * (g.y - e.y) &&
              this._triangle(b, e, g, c);
      },
      ...
      hitArea: function (b, a, c, d, f, e) {
        ...
        b.beginPath();
        e = 0;
        for (var k = a.length - 3; e < k; e += 2)
          (d.x = a[e] - p),
            (d.y = a[e + 1] - n),
            (h.x = a[e + 2] - p),
            (h.y = a[e + 3] - n),
            f && ((d = r.project(d, g)), (h = r.project(h, g))),
            (h.x - d.x) * (c.y - d.y) > (c.x - d.x) * (h.y - d.y) &&
              this._triangle(b, d, h, c);
        b.closePath();
        b.fill();
      },
    },
        ...
        if (!(x < G || Q)) {
          ...
          m.sort(function (a, b) {
            return (
              ...
              S(b.center, f) - S(a.center, f) ||
              b.height - a.height
            );
          });
          for (var l = 0, q = m.length; l < q; l++)
            if (((a = m[l]), !ia.isSimple(a) && ((e = a.footprint), V(e)))) {
              c = 1 > a.scale ? a.height * a.scale : a.height;
              d = 0;
              a.minHeight &&
                (d = 1 > a.scale ? a.minHeight * a.scale : a.minHeight);
              g = a.wallColor || ha;
              h = a.altColor || aa;
              k = a.roofColor || X;
              b.strokeStyle = h;
    ...
    ia = {
      ...
      render: function () {
        ...
        if (!(x < G || Q || x > this.maxZoom))
          for (var a, c, d = F.items, f = 0, e = d.length; f < e; f++)
            if (
              ((a = d[f]),
              !(a.height >= this.maxHeight) && ((c = a.footprint), V(c)))
            )
              switch (
                ((b.strokeStyle = a.altColor || aa),
                (b.fillStyle = a.roofColor || X),
                a.shape)
              ) {
                case "cylinder":
                case "cone":
    ...
    z = {
      ...
      direction: { x: 0, y: 0 },
      project: function (b, a) {
        return { x: b.x + this.direction.x * a, y: b.y + this.direction.y * a };
      },
      render: function () {
        var b = this.context,
          a,
        ...
        if (
          !(
            ...
            Q ||
            ((a = ja(W + p, fa + n)),
            (a = Ha(this.date, a.latitude, a.longitude)),
            0 >= a.altitude)
          )
        ) {
          c = 1 / ka(a.altitude);
          ...
          var f, e, g, h;
          a = F.items;
          b.canvas.style.opacity = d / (2 * C);
          b.shadowColor = this.blurColor;
          b.shadowBlur = (C / 2) * this.blurSize;
          b.fillStyle = this.color;
          b.beginPath();
          d = 0;
          for (c = a.length; d < c; d++)
            if (((f = a[d]), (h = f.footprint), V(h))) {
              e = 1 > f.scale ? f.height * f.scale : f.height;
              g = 0;
              f.minHeight &&
                (g = 1 > f.scale ? f.minHeight * f.scale : f.minHeight);
              switch (f.shape) {
                case "cylinder":
              ...
              switch (f.roofShape) {
                case "cone":
                  w.shadow(b, f.center, f.radius, 0, e + f.roofHeight, e);
                  break;
                case "dome":
                  w.shadow(
                    b,
          ...
          d = 0;
          for (c = a.length; d < c; d++)
            if (((f = a[d]), (h = f.footprint), V(h) && !f.minHeight))
              switch (f.shape) {
                case "cylinder":
                case "cone":
                case "dome":
      ...
      _render: function () {
        ...
        if (!(x < G || Q)) {
          ...
          for (var k = 0, m = h.length; k < m; k++)
            if (((a = h[k]), (g = a.hitColor)))
              if (((e = a.footprint), V(e))) {
                c = a.height;
                d = 0;
          ...
          B &&
            v &&
            (this._imageData = this.context.getImageData(0, 0, B, v).data);
        }
      },
    ...
    A = {
      ...
      setSize: function (b, a) {
        for (var c = 0, d = this.items.length; c < d; c++)
          (this.items[c].width = b), (this.items[c].height = a);
      },
  ...
  t.onAdd = function (b) {
    this.map = b;
    A.appendTo(b._panes.overlayPane);
    ...
    if (b.options.zoomAnimation) b.on("zoomanim", this.onZoom, this);
    b.attributionControl &&
      b.attributionControl.addAttribution(
  ...
  t.onRemove = function () {
    var b = this.map;
    b.attributionControl &&
      b.attributionControl.removeAttribution(
        '&copy; <a href="http://osmbuildings.org">OSM Buildings</a>'
      );
    b.off(
      {
  ...
  t.style = function (b) {
    ...
    if ((a = b.color || b.wallColor))
      (H = I.parse(a)),
        ...
        (O = H.lightness(1.2)),
        (X = "" + O.alpha(C));
    b.roofColor && ((O = I.parse(b.roofColor)), (X = "" + O.alpha(C)));
