...
!(function (t, e) {
  (L.Pattern = L.Class.extend({
    ...
    setStyle: function (t) {
      return (
        L.setOptions(this, t),
        this._map && (this._updateStyle(), this.redraw()),
        this
      );
    },
    addTo: function (t) {
    ...
    L.Map.include({
      addPattern: function (t) {
        ...
        return this._patterns[e]
          ? t
          : ((this._patterns[e] = t), this.whenReady(t.onAdd, t), this);
      },
      removePattern: function (t) {
        ...
        return this._patterns[e]
          ? (this._loaded && t.onRemove(this),
            ...
            delete this._patterns[e],
            this._loaded &&
              (this.fire("patternremove", { pattern: t }), t.fire("remove")),
            (t._map = null),
            this)
          : this;
      },
      ...
      _updateStyle: function () {
        ...
        if (t) {
          if (
            ...
            (i += e.angle ? "rotate(" + e.angle + ") " : ""),
              t.setAttribute("patternTransform", i);
        ...
        if (!this._defRoot)
          if ("function" == typeof this.getRenderer) {
            ...
            (this._defRoot = L.Pattern.prototype._createElement("defs")),
              t._container.appendChild(this._defRoot);
          } else
    ...
    L.SVG
      ? L.SVG.include({
          ...
          _updateStyle: function (t) {
            this._superUpdateStyle(t),
              t.options.fill &&
                t.options.fillPattern &&
                t._path.setAttribute(
                  "fill",
                  "url(#" + L.stamp(t.options.fillPattern) + ")"
                );
          },
        })
      : L.Path.include({
    ...
    (L.PatternShape = L.Class.extend({
      ...
      onAdd: function (t) {
        (this._pattern = t),
          this._pattern._dom && (this._initDom(), this._addDom());
      },
      addTo: function (t) {
      ...
      setStyle: function (t) {
        return (
          L.setOptions(this, t), this._pattern && this._updateStyle(), this
        );
      },
      setShape: function (t) {
    ...
    L.Pattern.include({
      addShape: function (t) {
        var e = L.stamp(t);
        return this._shapes[e]
          ? t
          : ((this._shapes[e] = t), t.onAdd(this), void 0);
      },
    }),
    ...
    (L.PatternShape = L.PatternShape.extend({
      ...
      _initDomElement: function (t) {
        (this._dom = this._createElement(t)),
          this.options.className &&
            L.DomUtil.addClass(this._dom, this.options.className),
          this._updateStyle();
      },
      ...
      _updateStyle: function () {
        ...
        t &&
          ...
          e.fill
            ? (e.fillPattern
                ? t.setAttribute("fill", "url(#" + L.stamp(e.fillPattern) + ")")
          ...
          t.setAttribute(
            "pointer-events",
            e.pointerEvents || (e.interactive ? "visiblePainted" : "none")
          ));
      },
    })),
